...
import { FaPenFancy, FaCheckCircle } from "react-icons/fa";
...
${userName}`;
  ...
  return (
    <section
      id="contact"
      className="relative min-h-screen bg-black text-white overflow-hidden py-16 px-5"
    >
      <AnimatePresence>
        {showToast && (
          <motion.div
            ...
            className="fixed top-6 left-1/2 -translate-x-1/2 z-[9999] w-[92%] max-w-md rounded-2xl border border-[#1cd8d2]/30 bg-black/85 backdrop-blur-xl px-5 py-4 shadow-[0_0_45px_rgba(28,216,210,0.25)]"
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-zinc-400">
                  Naitik Soni will connect with you soon.
                </p>
              </div>
            </div>
          </motion.div>
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute left-[-180px] bottom-[-180px] w-[620px] h-[440px] bg-[#00bf8f]/20 blur-[170px] rounded-full" />
        <div className="absolute right-[-180px] top-[80px] w-[620px] h-[440px] bg-[#0047ff]/20 blur-[180px] rounded-full" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        ...
        >
          <motion.div
            className="absolute w-[470px] h-[470px] rounded-full bg-[#1cd8d2]/10 blur-[90px]"
            animate={{
              scale: [1, 1.12, 1],
          ...
          <motion.img
            ...
            className="relative z-10 w-[500px] xl:w-[590px] drop-shadow-[0_0_75px_rgba(28,216,210,0.22)] transition-all duration-500"
          />
        </motion.div>
        ...
        <motion.div
          ...
          transition={{ duration: 0.7 }}
          viewport={{ once: true }}
          className="relative w-full max-w-xl mx-auto rounded-[32px] border border-white/10 bg-white/[0.045] backdrop-blur-2xl p-6 md:p-8 shadow-[0_0_80px_rgba(28,216,210,0.13)] overflow-hidden"
        >
          <div className="absolute inset-0 pointer-events-none bg-gradient-to-br from-[#1cd8d2]/10 via-transparent to-[#00bf8f]/10 opacity-50" />

          <p className="relative text-[#1cd8d2] tracking-[0.28em] text-xs font-black mb-3">
            SECURE CONTACT
          </p>

          <h2 className="relative text-4xl md:text-5xl font-black leading-tight bg-clip-text text-transparent bg-gradient-to-r from-[#1cd8d2] via-[#00bf8f] to-[#302b63]">
            Let’s Work Together
          </h2>

          <p className="relative mt-4 text-zinc-400 text-sm md:text-base leading-relaxed">
            Send me a direct message for cybersecurity, secure development,
            collaborations, or project discussions.
          </p>

          <form onSubmit={sendEmail} className="relative mt-8 space-y-4">
            <input
              type="text"
              name="name"
              required
              ...
              className="w-full rounded-2xl border border-white/10 bg-white/[0.07] px-5 py-4 text-white placeholder:text-zinc-500 outline-none focus:border-[#1cd8d2] focus:bg-white/[0.09] focus:shadow-[0_0_28px_rgba(28,216,210,0.16)] transition"
            />
            ...
            <div className="relative">
              <textarea
                ...
                className="custom-scrollbar w-full resize-none rounded-2xl border border-white/10 bg-white/[0.07] px-5 py-4 pr-16 text-white placeholder:text-zinc-500 outline-none focus:border-[#1cd8d2] focus:bg-white/[0.09] focus:shadow-[0_0_28px_rgba(28,216,210,0.16)] transition"
              />
