    ...
    >
      ...
      <div className="relative z-10 flex h-full flex-col">
        ...
        <main className="flex min-h-0 flex-1 flex-col items-center px-5">
          ...
          <div className="mt-8 w-full max-w-4xl flex-1 overflow-y-auto pb-32 ns-ai-scroll">
        ...
        <div className="absolute bottom-7 left-1/2 w-[92%] max-w-4xl -translate-x-1/2">
          <div
            className={`flex items-center gap-3 rounded-full px-3 py-3 shadow-[0_0_55px_rgba(236,72,153,0.24)] ${
              isDark ? "bg-[#242424]/95" : "bg-white/95 shadow-xl"
            }`}
          >
            <button className={`flex h-12 w-12 items-center justify-center rounded-full text-2xl ${isDark ? "bg-white/10 text-slate-300" : "bg-slate-100 text-slate-600"}`}>
              +
            </button>
            ...
            <button className={`hidden h-12 w-12 items-center justify-center rounded-full text-xl md:flex ${isDark ? "text-slate-400" : "text-slate-500"}`}>
              🎙
            </button>
